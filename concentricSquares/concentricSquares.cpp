...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInsatnce, LPSTR lpszCmdLine, int nCmdShow)
{
    ...
    MSG message;
    TCHAR szApplicationTitle[] = TEXT("CG - Concentric Squares");
    TCHAR szApplicationClassName[] = TEXT("RTR_OPENGL_CONCENTRIC_SQUARES");
    bool done = false;
...
void drawConcentricSquares(int numberOfSquares)
{
    ...
    GLfloat step = 1.0f / numberOfSquares;
