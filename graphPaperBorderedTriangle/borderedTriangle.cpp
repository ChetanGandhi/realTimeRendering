...
void drawBorderedTriangle(void);
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInsatnce, LPSTR lpszCmdLine, int nCmdShow)
{
    ...
    MSG message;
    TCHAR szApplicationTitle[] = TEXT("CG - Bordered Triangle on Graph Paper");
    TCHAR szApplicationClassName[] = TEXT("RTR_OPENGL_BORDERED_TRIANGLE_GRAPH_PAPER");
    bool done = false;
