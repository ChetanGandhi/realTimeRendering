...
-(instancetype)initWithFrame:(CGRect)frame
{
    ...
    if(self)
    {
        ...
        rotateLightOnXAxis = YES;
        rotateLightOnYAxis = NO;
        rotateLightOnZAxis = NO;
    }
...
-(void)onSingleTap:(UIGestureRecognizer *)gestureRecognizer
{
    ...
    if(singleTapCounter > 3) {
        singleTapCounter = 0;
    }

    switch(singleTapCounter) {
        case 1:
            // Rotating on X-Axis
            rotateLightOnXAxis = YES;
            rotateLightOnYAxis = NO;
        ...
        case 2:
            // Rotating on Y-Axis
            rotateLightOnXAxis = NO;
            rotateLightOnYAxis = YES;
            rotateLightOnZAxis = NO;
        break;
