...
let angleRedLight = 0.0;
let angleGreenLight = 0.0;
let angleBlueLight = 0.0;
let speed = 0.5;
...
let laTwoUniform = null;
let ldTwoUniform = null;
let lsTwoUniform = null;
let kaUniform = null;
let kdUniform = null;
let ksUniform = null;
...
let lightTwoPositionUniform = null;
...
let lightZeroPosition = [0.0, 0.0, 0.0, 0.0];

let lightOneAmbient = [0.0, 0.0, 0.0];
let lightOneDiffuse = [0.0, 1.0, 0.0];
let lightOneSpecular = [0.0, 1.0, 0.0];
let lightOnePosition = [0.0, 0.0, 0.0, 0.0];

let lightTwoAmbient = [0.0, 0.0, 0.0];
let lightTwoDiffuse = [0.0, 0.0, 1.0];
let lightTwoSpecular = [0.0, 0.0, 1.0];
let lightTwoPosition = [0.0, 0.0, 0.0, 0.0];
...
function initializeShaderProgramObject() {
    ...
    laOneUniform = gl.getUniformLocation(shaderProgramObject, "laOne");
    ldOneUniform = gl.getUniformLocation(shaderProgramObject, "ldOne");
    lsOneUniform = gl.getUniformLocation(shaderProgramObject, "lsOne");
    laTwoUniform = gl.getUniformLocation(shaderProgramObject, "laTwo");
    ldTwoUniform = gl.getUniformLocation(shaderProgramObject, "ldTwo");
    lsTwoUniform = gl.getUniformLocation(shaderProgramObject, "lsTwo");
    ...
    lightOnePositionUniform = gl.getUniformLocation(shaderProgramObject, "lightOnePosition");
    lightTwoPositionUniform = gl.getUniformLocation(shaderProgramObject, "lightTwoPosition");
...
function display() {
    ...
    if (isLightingEnabled) {
        ...
        lightZeroPosition[1] = Math.sin(degreeToRadian(angleRedLight)) * 100.0;
        lightZeroPosition[2] = Math.cos(degreeToRadian(angleRedLight)) * 100.0 - 3.0;
        gl.uniform4fv(lightZeroPositionUniform, lightZeroPosition);

        lightOnePosition[0] = Math.sin(degreeToRadian(angleGreenLight)) * 100.0;
        lightOnePosition[1] = 0.0;
        lightOnePosition[2] = Math.cos(degreeToRadian(angleGreenLight)) * 100.0 - 3.0;
        gl.uniform4fv(lightOnePositionUniform, lightOnePosition);

        lightTwoPosition[0] = Math.cos(degreeToRadian(angleBlueLight)) * 100.0;
        lightTwoPosition[1] = Math.sin(degreeToRadian(angleBlueLight)) * 100.0;
        lightTwoPosition[2] = -3.0;
