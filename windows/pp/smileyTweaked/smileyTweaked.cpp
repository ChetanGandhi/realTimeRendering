...
GLuint textureWhiteColor = 0;
GLuint textureMode = 0;
...
void makeWhiteColorTexture(void);
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInsatnce, LPSTR lpszCmdLine, int nCmdShow)
{
    ...
    MSG message;
    TCHAR szApplicationTitle[] = TEXT("CG - PP - Smiley Tweaked");
    TCHAR szApplicationClassName[] = TEXT("RTR_OPENGL_PP_SMILEY_TWEAKED");
    bool done = false;
