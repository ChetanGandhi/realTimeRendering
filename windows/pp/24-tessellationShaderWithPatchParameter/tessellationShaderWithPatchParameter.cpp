        ...
        case WM_KEYDOWN:
            switch(wParam)
            {
                ...
                case VK_UP:
                    ...
                    {
                        lineColor = vmath::vec4(0.0f, 0.0f, 1.0f, 1.0f);
                ...
                case VK_DOWN:
                    ...
                    {
                        lineColor = vmath::vec4(0.0f, 1.0f, 0.0f, 1.0f);
...
void initializeTessellationControllShader()
{
    ...
    const GLchar *tessellationControllShaderCode = "#version 430 core" \
        "\n" \
...
void initializeTessellationEvaluationShader()
{
    ...
    const GLchar *tessellationEvaluationShaderCode = "#version 430 core" \
        "\n" \
        "layout(isolines) in;" \
