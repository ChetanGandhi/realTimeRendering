...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInsatnce, LPSTR lpszCmdLine, int nCmdShow)
{
    ...
    MSG message;
    TCHAR szApplicationTitle[] = TEXT("CG - PP - Interleaved Cube using Array");
    TCHAR szApplicationClassName[] = TEXT("RTR_OPENGL_PP_INTERLEAVED_CUBE_ARRAY");
    bool done = false;
...
void initializeCubeBuffers()
{
    ...
    const GLfloat interleavedData[24][11] = {
        // Top face
