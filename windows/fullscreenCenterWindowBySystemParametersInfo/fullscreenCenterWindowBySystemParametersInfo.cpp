...
void getCenterPosition(RECT *centerPosition)
{
    ...
    centerPosition->left = (screenSize.right - screenSize.left - centerPosition->right) / 2;
    centerPosition->top = (screenSize.bottom - screenSize.top - centerPosition->bottom) / 2;
}
