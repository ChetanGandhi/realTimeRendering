...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInsatnce, LPSTR lpszCmdLine, int nCmdShow)
{
    ...
    HWND hWnd;
    MSG message;
    TCHAR szApplicationTitle[] = TEXT("CG - Custom Icon");
    TCHAR szApplicationClassName[] = TEXT("RTR_WINDOW_CUSTOM_ICON");

    if(LoadCursor(hInstance, MAKEINTRESOURCE(CP_CURSOR)) == NULL)
    {
    ...
    wndClassEx.hCursor = LoadCursorFromFile(TEXT("resources\\face.cur"));
