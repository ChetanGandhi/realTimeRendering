...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInsatnce, LPSTR lpszCmdLine, int nCmdShow)
{
    ...
    MSG message;
    TCHAR szApplicationTitle[] = TEXT("CG - Point Circle on Graph Paper");
    TCHAR szApplicationClassName[] = TEXT("RTR_OPENGL_POINT_CIRCLE_GRAPH_PAPER");
    bool done = false;
