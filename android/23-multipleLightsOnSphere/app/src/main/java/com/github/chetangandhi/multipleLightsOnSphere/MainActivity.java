...
public class MainActivity extends Activity {
    ...
    private MultipleLightsOnSphere multipleLightsOnSphere = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.multipleLightsOnSphere = new MultipleLightsOnSphere(this);

        // Set textView as content view of the activity.
        setContentView(this.multipleLightsOnSphere);
    }
}
