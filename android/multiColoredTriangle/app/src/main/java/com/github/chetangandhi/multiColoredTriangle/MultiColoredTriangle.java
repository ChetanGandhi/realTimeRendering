package com.github.chetangandhi.multiColoredTriangle;
...
public class MultiColoredTriangle extends GLSurfaceView implements GLSurfaceView.Renderer, OnGestureListener, OnDoubleTapListener {
    ...
    MultiColoredTriangle(Context context) {
        super(context);
    ...
    private void cleanUp() {
        ...
        if(this.vboPosition[0] != 0)
        {
            GLES32.glDeleteBuffers(1, this.vboPosition, 0);
            this.vboPosition[0] = 0;
        }

        if(this.vboColor[0] != 0)
        {
            GLES32.glDeleteBuffers(1, this.vboColor, 0);
            this.vboColor[0] = 0;
        }
