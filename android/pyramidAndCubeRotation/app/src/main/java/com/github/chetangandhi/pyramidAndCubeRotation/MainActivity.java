...
public class MainActivity extends Activity {
    ...
    private PyramidAndCubeRotation pyramidAndCubeRotation = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.pyramidAndCubeRotation = new PyramidAndCubeRotation(this);

        // Set textView as content view of the activity.
        setContentView(pyramidAndCubeRotation);
    }
}
