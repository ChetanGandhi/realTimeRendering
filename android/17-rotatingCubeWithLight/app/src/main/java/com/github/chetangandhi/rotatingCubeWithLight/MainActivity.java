...
public class MainActivity extends Activity {
    ...
    private RotatingCubeWithLight rotatingCubeWithLight = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.rotatingCubeWithLight = new RotatingCubeWithLight(this);

        // Set textView as content view of the activity.
        setContentView(this.rotatingCubeWithLight);
    }
}
