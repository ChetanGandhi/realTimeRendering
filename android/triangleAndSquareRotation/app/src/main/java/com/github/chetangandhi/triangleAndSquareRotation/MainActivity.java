...
public class MainActivity extends Activity {
    ...
    private TriangleAndSquareRotation triangleAndSquareRotation = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.triangleAndSquareRotation = new TriangleAndSquareRotation(this);

        // Set textView as content view of the activity.
        setContentView(triangleAndSquareRotation);
    }
}
