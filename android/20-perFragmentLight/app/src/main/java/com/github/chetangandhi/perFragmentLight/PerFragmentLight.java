...
public class PerFragmentLight extends GLSurfaceView implements GLSurfaceView.Renderer, OnGestureListener, OnDoubleTapListener {
    ...
    PerFragmentLight(Context context) {
        super(context);
