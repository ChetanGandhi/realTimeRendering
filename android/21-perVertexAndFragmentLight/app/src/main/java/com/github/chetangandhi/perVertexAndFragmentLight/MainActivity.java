...
public class MainActivity extends Activity {
    ...
    private PerVertexAndFragmentLight perVertexAndFragmentLight = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.perVertexAndFragmentLight = new PerVertexAndFragmentLight(this);

        // Set textView as content view of the activity.
        setContentView(this.perVertexAndFragmentLight);
    }
}
