package com.github.chetangandhi.triangleOrtho;
...
public class TriangleOrtho extends GLSurfaceView implements GLSurfaceView.Renderer, OnGestureListener, OnDoubleTapListener {
    ...
    private void resize(int width, int height) {
        ...
        if(width <= height)
        {
            ...
            Matrix.orthoM(this.orthographicProjectionMatrix, 0, -100.0f, 100.0f, -100.0f * ratio, 100.0f * ratio, -100.0f, 100.0f);
        }
        else
        {
            ratio = (float)width / (float)height;
            Matrix.orthoM(this.orthographicProjectionMatrix, 0, -100.0f * ratio, 100.0f * ratio, -100.0f, 100.0f, -100.0f, 100.0f);
        }
    }
