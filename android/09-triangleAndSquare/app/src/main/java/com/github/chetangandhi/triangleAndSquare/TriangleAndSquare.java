package com.github.chetangandhi.triangleAndSquare;
...
public class TriangleAndSquare extends GLSurfaceView implements GLSurfaceView.Renderer, OnGestureListener, OnDoubleTapListener {
    ...
    TriangleAndSquare(Context context) {
        super(context);
    ...
    private void initializeTriangleBuffers() {
        ...
        GLES32.glGenBuffers(1, this.vboTriangle, 0);
        GLES32.glBindBuffer(GLES32.GL_ARRAY_BUFFER, this.vboTriangle[0]);
    ...
    private void initializeSquareBuffers() {
        ...
        GLES32.glGenBuffers(1, this.vboSquare, 0);
        GLES32.glBindBuffer(GLES32.GL_ARRAY_BUFFER, this.vboSquare[0]);
    ...
    private void cleanUp() {
        ...
        if(this.vboTriangle[0] != 0)
        {
            GLES32.glDeleteBuffers(1, this.vboTriangle, 0);
            this.vboTriangle[0] = 0;
        }
        ...
        if(this.vboSquare[0] != 0)
        {
            GLES32.glDeleteBuffers(1, this.vboSquare, 0);
            this.vboSquare[0] = 0;
        }
