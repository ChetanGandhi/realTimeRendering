...
public class TrianglePerspective extends GLSurfaceView implements GLSurfaceView.Renderer, OnGestureListener, OnDoubleTapListener {
    ...
    TrianglePerspective(Context context) {
        super(context);
