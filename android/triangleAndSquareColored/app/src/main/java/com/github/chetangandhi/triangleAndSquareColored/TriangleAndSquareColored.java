...
public class TriangleAndSquareColored extends GLSurfaceView implements GLSurfaceView.Renderer, OnGestureListener, OnDoubleTapListener {
    ...
    TriangleAndSquareColored(Context context) {
        super(context);
